...
export function getServerTimeHeaderField(serverTimings: PerformanceServerTimings) {
...
type ServerTiming = ReturnType<typeof getServerTiming>;
export type ServerTimingTimeFn = ServerTiming['time'];
